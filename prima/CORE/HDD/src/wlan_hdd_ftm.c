...
/// BSP: statistics the packets received @{
extern char wlan_ftm[];
/// @}
...
static VOS_STATUS wlan_ftm_priv_get_rx_pkt_count(hdd_adapter_t *pAdapter,v_U16_t *pRxPktCnt)
{
    ...
    long ret;
	/// BSP: statistics the packets received @{
    int ftm_0, ftm_1, ftm_2;
    char str_0[10], str_1[10], str_2[10];
    /// @}
    hdd_context_t *pHddCtx = (hdd_context_t *)pAdapter->pHddCtx;
    ...
    *pRxPktCnt = pMsgBody->GetRxPktCounts.counters.totalRxPackets;
    /// BSP: statistics the packets received @{
    ftm_0 = pMsgBody->GetRxPktCounts.counters.totalRxPackets;
    ftm_1 = pMsgBody->GetRxPktCounts.counters.totalMacRxPackets;
    ftm_2 = pMsgBody->GetRxPktCounts.counters.totalMacFcsErrPackets;
    sprintf(str_0, "%d", ftm_0);
    sprintf(str_1, "%d", ftm_1);
    sprintf(str_2, "%d", ftm_2);
    snprintf(wlan_ftm, 120, "totalRxPackets %s totalMacRxPackets %s totalMacFcsErrPackets %s", str_0, str_1, str_2);
    /// @}
done:
